            ...
            Container(
              ...
              child: GoogleMap(
                onTap: (latlng) async {
                  ...
                  chargerModel.chargerLocation = GeoPoint(latlng.latitude, latlng.longitude);
                  chargerLocation = latlng.toString();

                  // ✅ Get state & address using geocoding package
                  ...
                  // ✅ Fetch unit price for state from Firebase
                  ...
                  setState(() {
                    ...
                    elecUnitPrice2 = "$state: ₹${data[state]} / Unit";

                    chargerLoc = fullAddress;
                  });
